...
<div class="col-lg-6 col-lg-offset-3">
    <div class="panel">
        <div class="panel-heading bord-btm">
            <h3 class="panel-title">{{ translate('Install New Addon')}}</h3>
        </div>
        ...
        <form class="form-horizontal" action="{{ route('addons.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                <div class="form-group mar-no">
                    <label class="col-sm-2 control-label" for="addon_zip">{{ translate('Zip File')}}</label>
                    <div class="col-sm-10">
            ...
            <div class="panel-footer text-right">
                <button class="btn btn-purple" type="submit">{{ translate('Install')}}</button>
            </div>
        </form>
        <!--===================================================-->
        <!--End Horizontal Form-->
