...
<div class="col-lg-12">
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">{{translate('Product Stock Information')}}</h3>
        </div>
        ...
        <form class="form-horizontal" action="{{ route('stocks.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label" for="name">{{translate('Subcategory')}}</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label" for="name">{{translate('Sub Subcategory')}}</label>
                    <div class="col-lg-9">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">{{translate('SKU')}}</h3>
            </div>
