                                ...
                                <div class="card-body p-0">
                                    <div class="card-image">
                                        <a href="{{ route('customer.product', $product->slug) }}" class="d-block">
                                            <img class="img-fit lazyload mx-auto" src="{{ asset('../frontend/images/placeholder.jpg') }}" data-src="{{ asset($product->thumbnail_img) }}" alt="{{  translate($product->name) }}">
                                        </a>
                                        </a>
                                    </div>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <h2 class="product-title p-0 text-truncate-2">
                                            <a href="{{ route('customer.product', $product->slug) }}">{{  translate($product->name) }}</a>
                                        </h2>
                                    </div>
                                </div>
                            </div>
