                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mx-auto">
                                            <div class="row">
                                               ...
                                               @endif
                                                @if(\App\BusinessSetting::where('type', 'twocheckout')->first()->value == 1)
                                                   <div class="col-6">
                                                       <label class="payment_option mb-4" data-toggle="tooltip" data-title="2checkout">
                                                           <input type="radio" id="" name="payment_option" value="twocheckout" checked>
                                                           <span>
                                                               <img loading="lazy"  src="{{ asset('../frontend/images/icons/cards/twocheckout.png')}}" class="img-fluid">
                                                           </span>
                                                       </label>
                                                   </div>
                                               @endif
