                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="card-image">
                                                    <a href="{{ route('product', $product->slug) }}" class="d-block">
                                                        <img  class="mx-auto img-fit lazyload" src="{{ asset('../frontend/images/placeholder.jpg') }}" data-src="{{ asset($product->featured_img) }}" alt="{{  translate($product->name) }}">
                                                    </a>
                                                </div>
                                                ...
                                                <div class="p-3">
                                                    ...
                                                    <h2 class="product-title p-0 text-truncate-2">
                                                        <a href="{{ route('product', $product->slug) }}">{{  translate($product->name) }}</a>
                                                    </h2>
